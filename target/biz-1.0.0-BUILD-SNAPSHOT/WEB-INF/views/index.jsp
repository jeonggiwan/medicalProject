						...
						<tbody>
							<c:forEach items="${pdataList}" var="pdata">
								<tr>
									...
									<td class="table-cell">${pdata.pid}</td>
									<td class="table-cell">${pdata.pname}</td>
									<td class="table-cell">${pdata.modality}</td>
									<td class="table-cell">${pdata.studyDesc}</td>
									<td class="table-cell">${pdata.studyDate}</td>
									<td class="table-cell">${pdata.reportStatus}</td>
									<td class="table-cell">${pdata.imageCnt}</td>
