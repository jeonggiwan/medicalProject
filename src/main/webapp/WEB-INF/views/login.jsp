...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
	<div class="login-container">
		<h1 class="login-title">WELCOME MERCY</h1>
		...
		<div class="footer-links">
			<a href="<c:url value='/forgot-id'/>" class="footer-link">아이디 찾기 ㅣ</a> 
			<a href="<c:url value='/forgot-password'/>" class="footer-link">비밀번호 찾기 ㅣ </a> 
